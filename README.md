...
**📊 Status board:** ✅ 96 shipped · 🔨 3 in build · 💤 10 queued (109 tracked) — full tables in [`STATUS.md`](STATUS.md), source of truth [`brain/roadmap.json`](brain/roadmap.json).
...
| 💤 | **🖥️ TDE Models panel reads brain/modelFamily.json (real state replaces the mock model cards)** | `10.3` |
