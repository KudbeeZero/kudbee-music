...
- [x] **Watchdog** — a founder-triggered Claude review of the repo's security posture + quality, filed as a GitHub issue with concrete findings and research ideas ([docs/watchdog.md](docs/watchdog.md))
