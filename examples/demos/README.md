...
|------|-------|--------------|-------|
| **Midnight Shift** | lo-fi soul hip-hop | 92/100 | [explore](midnight-shift/trace.html) · [trace.md](midnight-shift/trace.md) · [song.json](midnight-shift/song.json) |
| **Concrete Garden** | boom-bap hip-hop | 97/100 | [explore](concrete-garden/trace.html) · [trace.md](concrete-garden/trace.md) · [song.json](concrete-garden/song.json) |
| **Signal Fade** | synthwave pop | 98/100 | [explore](signal-fade/trace.html) · [trace.md](signal-fade/trace.md) · [song.json](signal-fade/song.json) |
| **Paper Crowns** | drill-influenced trap | 98/100 | [explore](paper-crowns/trace.html) · [trace.md](paper-crowns/trace.md) · [song.json](paper-crowns/song.json) |
