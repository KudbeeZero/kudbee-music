...
|------|-------|--------------|-------|
| **Midnight Shift** | lo-fi soul hip-hop | 93/100 | [trace](midnight-shift/trace.md) · [song.json](midnight-shift/song.json) |
| **Concrete Garden** | boom-bap hip-hop | 98/100 | [trace](concrete-garden/trace.md) · [song.json](concrete-garden/song.json) |
| **Signal Fade** | synthwave pop | 97/100 | [trace](signal-fade/trace.md) · [song.json](signal-fade/song.json) |
| **Paper Crowns** | drill-influenced trap | 97/100 | [trace](paper-crowns/trace.md) · [song.json](paper-crowns/song.json) |
| **Hometown Ghosts** | acoustic folk-rap | 91/100 | [trace](hometown-ghosts/trace.md) · [song.json](hometown-ghosts/song.json) |
