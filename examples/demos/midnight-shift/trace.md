...
| **Generative (right hemisphere)** | Wrote the hook from 5 candidates → “Still standing where the graveyard used to be”. |
...
- **Lead hook:** “Still standing where the graveyard used to be” _(chosen from 5 candidates)_
