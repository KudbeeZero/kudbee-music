# Generation trace — “Paper Crowns”

> **Deterministic.** Seed `26`, minted by `lib/hermes/pipeline.ts`. $0, fully local, no API key.
...
**Brief** — theme: *refusing the fake status games and crowning yourself on your own terms* · mood: *cold, confident, sharp* · genre: *drill-influenced trap* · structure: *hook-first*

## 🧠 What each region contributed

| Region | Contribution |
|--------|--------------|
| **Intent (prefrontal)** | Framed the brief → “Drill-Influenced Trap record for the doubters: refusing the fake status games and crowning yourself on your own terms — delivered cold, confident, sharp, voiced as hard.” |
...
| **Generative (right hemisphere)** | Wrote the hook from 5 candidates → “This one's for the yourself that raised me”. |
...
- **Lead hook:** “This one's for the yourself that raised me” _(chosen from 5 candidates)_
